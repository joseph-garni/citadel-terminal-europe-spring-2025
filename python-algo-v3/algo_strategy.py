...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def starter_strategy(self, game_state):
        ...
        turret_locations_3 = [
            [6, 11], [21, 11], [3, 12], [4, 11], [4, 10], [6, 12], 
            [21, 12], [24, 12], [24, 11], [23, 11], [23, 10]
        ]

        game_state.attempt_spawn(TURRET, turret_locations_3)

        support_locations_1 = [
            [2, 12], [25, 12]
        ]

        game_state.attempt_spawn(TURRET, support_locations_1)

        support_locations_2 = [
            [13, 7]
        ]

        game_state.attempt_spawn(TURRET, support_locations_2)

        
        support_locations_3 = [
            [7, 11], [8, 11], [8, 10], [20, 11], [19, 11], [19, 10]
        ]

        game_state.attempt_spawn(TURRET, support_locations_3)
        '''
        ...
        # If the turn is less than 5, stall with interceptors and wait to see enemy's base
            ...
            # If they have many units in the front we can build a line for our demolishers to attack them at long range.
            # They don't have many units in the front so lets figure out their least defended area and send Scouts there.
        #support_locations = [[20, 12], [20, 11], [20, 10], [20, 9], [16, 12], [16, 11], [11, 12], [11, 11], [15, 7], [18, 7], [12, 9], [11, 9], [10, 9]]
        #game_state.attempt_spawn(TURRET, support_locations, 1000)
        #support_locations_2 = [[19, 12],[19, 11], [19, 10], [19, 9], [19, 8], [18, 8], [17, 8], [16, 8], [15, 8]]
        #game_state.attempt_spawn(WALL, support_locations_2, 1000)
    ...
    def build_defences(self, game_state):
        ...
        turret_locations = [
            ...
            [26, 12], [25, 11], [24, 10], [20, 10], [3, 13], [4, 13], [25, 12], [8, 11], [5, 12], [4, 12], [9, 8], [7,7], [11, 6], [7, 6]]
    ...
    def scouts_funnel_strategy_1(self, game_state):
        """
        ...
        scout_spawn_location_options = [[13, 0], [12, 1]]
        best_location = self.least_damage_spawn_location(game_state, scout_spawn_location_options)
    ...
    def scouts_funnel_strategy_2(self, game_state):
        """
        Using the funnel strategy from our turrets and walls we have placed earlier, 
        now spawn 5 - 10+ scounts (when points all it possible), to score on 
        enemy side using funnel
        ...
        # Calculate how many scouts we can afford, up to 10
        max_scouts = min(int(available_mp / scout_cost), 20)
        ...
        # Choose the best spawn location
        scout_spawn_location_options = [[14, 0], [15, 1]]
        best_location = self.least_damage_spawn_location(game_state, scout_spawn_location_options)
        
        # Spawn the scouts
        scouts_spawned_1 = game_state.attempt_spawn(SCOUT, best_location, max_scouts)
        
        return scouts_spawned_1 > 0
